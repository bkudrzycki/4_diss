...
\renewcommand{\maketitle}{%
    ...
    $endfor$
		...
		\includegraphics[viewport=90 -45 0 -60]{figures/logo.jpg} \hfill

		\begin{center}
				\vspace{-3.5cm}
		    
		    {\large DISS. ETH NO. \dissno}
		    ...
		    \vspace{1.5cm}
			  ...
			  Presented by \\[12pt]  \MakeUppercase{\@author} \\[12pt] MA, University of Zürich, Switzerland
